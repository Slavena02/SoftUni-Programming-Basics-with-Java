...
public class P04Grades {
    public static void main(String[] args) {
        ...
        double topStudents = count4 /countStudent * 100;
        double between4 = count3 /countStudent * 100;
        double between3 = count2 /countStudent * 100;
        double fail = count1 /countStudent * 100;
        ...
        System.out.printf("Average: %.2f",arithmeticMean);
    }
}
